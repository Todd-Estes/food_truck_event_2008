...
class EventTest < Minitest::Test
  ...
  def test_it_can_add_and_have_food_trucks
  ...
  def test_trucks_sell_items_and_make_money
    ...
    assert_equal [food_truck1, food_truck2],  event.food_trucks_that_sell(item1)
